...
public:
    Nivel1(sf::RenderWindow& ventana, b2World& mundo) : window(ventana), world(mundo), nivelCompletado(false) {
        // Cargar textura de la caja de madera
        ...
        // Imprime informacin de depuracion
        std::cout << "Textura cargada correctamente" << std::endl;
        std::cout << "Tama�o de la textura: " << texturaCajaMadera.getSize().x << "x" << texturaCajaMadera.getSize().y << std::endl;
        ...
        // Crea caja objetivo (naranja)
        cajaObjetivo.setSize(sf::Vector2f(100.f, 100.f));
        cajaObjetivo.setOrigin(50.f, 50.f);
        cajaObjetivo.setPosition(700.f, 500.f);
        cajaObjetivo.setFillColor(sf::Color(255, 165, 0)); // Color naranja
        ...
        // Crea cuerpo fsico para la caja objetivo
        b2BodyDef objetivoDef;
        objetivoDef.position.Set(700.f / 30.f, 500.f / 30.f);
        ...
        // Crea obstaculos estaticos
        crearObstaculo(400.f, 400.f, 60.f, 120.f, sf::Color(150, 75, 0)); 
        crearObstaculo(550.f, 300.f, 80.f, 20.f, sf::Color::Green);      
        crearObstaculo(300.f, 200.f, 20.f, 200.f, sf::Color::Yellow);   

        // Crear obstaculos dinamicos 
        crearObstaculoDinamico(200.f, 300.f, 60.f, 60.f, sf::Color::Transparent);    
    ...
    void actualizar() {
        // Actualizar posicion de los obstaculos dinamicos
    ...
    bool verificarColision(b2Body* ragdollBody) {
        // Verifica si algun ragdoll esta dentro de la caja objetivo
        ...
        // Imprime informacian de depuracian
        std::cout << "Posici�n Ragdoll: (" << posRagdoll.x << ", " << posRagdoll.y << ")" << std::endl;
        std::cout << "Posici�n Objetivo: (" << posObjetivo.x << ", " << posObjetivo.y << ")" << std::endl;
        std::cout << "Distancia X: " << distanciaX << ", Distancia Y: " << distanciaY << std::endl;

        // Si el ragdoll esta dentro de la caja 
        if (distanciaX < 60.f / 30.f && distanciaY < 60.f / 30.f) {
